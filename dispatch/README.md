...
| `dandi_instance` | DANDI archive instance name (per `dandi instance-list`). Defaults to `ember-dandi`, which every registered project uses. Set it only for a project that lives somewhere else, such as a sandbox instance. |
