...
# Kemere image and the DANDI-cache repositories. It provides Python 3.13.
FROM neurodebian:trixie

LABEL org.opencontainers.image.source="https://github.com/brain-bbqs/data-ingest-task-force"
LABEL org.opencontainers.image.description="Pinned runtime environment for the Inman-lab .mat-to-NWB conversion pipeline (labs/inman/)."

# Python and the basics for cloning and TLS. The converter has no system-level
# dependencies beyond Python; everything else is a Python package.
RUN apt-get update \
