...
LABEL org.opencontainers.image.description="Pinned runtime environment for the Sanes-lab gerbil-vocal-interaction-to-NWB conversion pipeline (labs/sanes/)."
