...
# Kemere, Inman and Shepherd images and the DANDI-cache repositories. It
# provides Python 3.13. This pipeline has no system-level dependencies beyond
# that: the raw .mat files are MATLAB v7.3, which is HDF5, so h5py reads them
...
LABEL org.opencontainers.image.description="Pinned runtime environment for the Suthana-lab in-lab navigation-to-NWB conversion pipeline (labs/suthana/in-lab/)."
