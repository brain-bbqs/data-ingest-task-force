...
# images. It provides Python 3.13.
FROM neurodebian:trixie

LABEL org.opencontainers.image.source="https://github.com/brain-bbqs/data-ingest-task-force"
LABEL org.opencontainers.image.description="Pinned runtime environment for the Zhang-lab ferret hyperscanning to NWB conversion pipeline (labs/zhang/ferret-hyperscanning/)."

# Python and the basics for cloning and TLS. The converter has no system-level
# dependencies beyond Python; PyAV bundles the FFmpeg libraries it needs.
RUN apt-get update \
